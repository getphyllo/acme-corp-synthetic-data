...
| **Larksfield Foods promo intensification at Rouses** | 2025-10-13 onward; 21% off Field & Honey 14oz; 6 waves through Q1 2026 | `seeds/promo_events_louisiana.csv` (E001-E015 hand-curated), `epos` (LA Field & Honey Yes/Yes promo), `perfect_store` (Field & Honey at Rouses promo flag), `social_mentions` (Field & Honey viral wave Q4 2025), `competitor_launches` (LCH00001 Field & Honey Almond) |
